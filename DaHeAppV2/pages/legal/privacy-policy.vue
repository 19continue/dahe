  ...
  <view class="page record-style-page" :class="{ 'elder-mode': elderMode }">
    ...
    <scroll-view scroll-y class="content" :show-scrollbar="false">
      <view class="hero-card">
        ...
        <text class="hero-desc">请你在授权登录、提交认证、上传图片、使用定位等能力前，了解我们如何收集、使用和保护你的个人信息。</text>
      </view>
...
import { buildPrivacyPolicySections, loadLegalCompanyProfile } from '../../utils/legal-content'
...
export default {
  ...
  data() {
    return {
      companyName: '大禾种业',
      contacts: [],
      sections: buildPrivacyPolicySections('大禾种业')
    }
  },
  async onLoad() {
    ...
    this.sections = buildPrivacyPolicySections(this.companyName)
  },
  methods: {
    goBack() {
      uni.navigateBack()
